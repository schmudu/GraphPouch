...
extern NSString *const EDEquationAttributeInequalityAlpha;
extern float const EDEquationAttributeInequalityAlphaDefault;
extern NSString *const EDEquationAttributeInequalityColor;
extern NSString *const EDEquationAttributeInequalityColorDefault;
...
extern float const EDEquationSheetFieldErrorVerticalPosition;
extern float const EDEquationSheetButtonVerticalPosition;
...
extern NSString *const EDEventResetZIndices;
