//
//  EDPanelPropertiesGraphLineTextboxController.m
//  GraphPouch
//
...
@interface EDPanelPropertiesGraphLineTextboxController ()

@end

@implementation EDPanelPropertiesGraphLineTextboxController
