...
float const EDEquationSheetFieldErrorVerticalPosition           = 60;
float const EDEquationSheetButtonVerticalPosition               = 10;
...
NSString * const EDEventMouseUpOverUnselectedElement            = @"EDEventMouseUpOverUnselectedElement";
